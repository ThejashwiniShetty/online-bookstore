...
CREATE TABLE IF NOT EXISTS ITEMS_DETAIL {
  ...
  CONSTRAINT fk_category_id FOREIGN KEY (CATEGORY_ID) REFERENCES CATEGORIES_DETAIL (CATEGORY_ID),
  CONSTRAINT fk_brand_id FOREIGN KEY (BRAND_ID) REFERENCES BRAND_DETAIL (BRAND_ID)
};
